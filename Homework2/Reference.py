...
def heuristic(board,myPiece):
    ...
    if myPiece == pieceType:
        return 2*heuristicMax -0.5*myEdges - myCorner - 2*heuristicMin + 0.5*oppEdges + oppCorner
    else:
        return 2*heuristicMin - 2*heuristicMax  +0.5*myEdges + myCorner - 0.5*oppEdges - oppCorner
